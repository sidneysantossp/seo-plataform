            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Gerencie todos os arquivos e documentos do projeto {project.name}
                  </CardDescription>
                </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      { name: 'relatorio-seo-inicial.pdf', size: '2.4 MB', type: 'PDF', author: 'Carlos Oliveira' },
                      { name: 'analise-palavras-chave.xlsx', size: '1.1 MB', type: 'Excel', author: 'Mariana Santos' },
                      { name: 'screenshot-homepage.png', size: '850 KB', type: 'Imagem', author: 'Roberto Ferreira' }
                    ].map((file, index) => (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                              {file.size} • {file.type} • {file.author}
                            </p>
                          </div>
                        </div>
